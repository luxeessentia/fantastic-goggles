...
export default function ProductCard({ product, onAdd }) {
  ...
  return (
    <div className='card'>
      ...
      <button
        className={'cart-fab ' + (inStock ? '' : 'disabled')}
        aria-label='Add to cart'
        onClick={(e) => { e.preventDefault(); e.stopPropagation(); if(!inStock) return; onAdd && onAdd(product); }}
        title={inStock ? 'Add to cart' : 'Sold out'}
      >
        <svg width='18' height='18' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='1.8'>
          <circle cx='9' cy='20' r='1'></circle><circle cx='18' cy='20' r='1'></circle>
          <path d='M2 2h3l3.6 7.59a2 2 0 0 0 1.7 1.16h7.72a2 2 0 0 0 1.93-1.5L23 6H6'></path>
        </svg>
      </button>
    </div>
  );
